...
class TestMenuBarController: UITabBarController, CNContactViewControllerDelegate {
    ...
    func showEditName(value: String) {
        ...
        let Popover = UIStoryboard(name: "NewMain", bundle: nil).instantiateViewController(withIdentifier: "edit") as! TestPopUpUbahDataController
